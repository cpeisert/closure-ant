...
/**
 * Custom version of {@link
 * org.apache.tools.ant.taskdefs.optional.junit.PlainJUnitResultFormatter}.
 *
 * @author cpeisert{at}gmail{dot}com (Christopher Peisert)
 */
public class CustomJUnitResultFormatter implements JUnitResultFormatter {
   ...
   * Timing helper.
   */
  private final Map<Test, Object> testStarts = Maps.newHashMap();
  /**
   ...
   */
  private final StringWriter inner;
  /**
   * Convenience layer on top of {@link #inner inner}.
   */
  private final BufferedWriter wri;
  /**
   * Suppress endTest if testcase failed.
   */
  private Map<Test, Object> failed = Maps.newHashMap();

  private String systemOutput = null;
  private String systemError = null;

  /** No arg constructor */
  public CustomJUnitResultFormatter() {
  ...
  /**
   * <b>Not Implemented!</b> The whole test suite started.
  ...
  public void endTestSuite(JUnitTest suite) throws BuildException {
    ...
    if (out != null) {
      try {
        ...
        wri.newLine(); // add blank line after last test in the test suite
        wri.newLine();
        wri.close();
